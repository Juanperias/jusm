...
pub fn store(arg: StoreArgs) -> Vec<u8> {
    let ins = ((arg.imm & 0b00000000_00000000_00000000_00000000_00000000_00000000_00001111_11100000)
        as u32)
        << 25
        | arg.rs2 << 20
        | arg.rs1 << 15
        | arg.funct3 << 12
        | ((arg.imm & 0b00000000_00000000_00000000_00000000_00000000_00000000_00000000_00011111)
            as u32)
            << 7
        | arg.opcode;
